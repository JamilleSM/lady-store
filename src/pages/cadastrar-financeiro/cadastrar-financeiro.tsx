    ...
    return (
        ...
        <div className="container-financeiro">
            ...
            <Cadastro text="Gerenciamento de Receitas" modulo="Cadastrar Receita">
                <Input label='Data da operação' placeholder='Ex.: Camisa' type='date' {...register('transaction_date')} error={errors.transaction_date?.message} />
                <Input label='Tipo de operação' placeholder='Ex.: Receita ou Despesa' type='text' {...register('transaction_type')} error={errors.transaction_type?.message} />
                <Input label='Valor' placeholder='Ex.: Gola Polo' type='text' {...register('amount')} error={errors.amount?.message} />
                <Input label='Descrição' placeholder='Ex.: Pagamento no cartão' type='text' {...register('description')} error={errors.description?.message} />
